import{r as i,j as a}from"./index-T95mXPsV.js";function l(){const[e,o]=i.useState({name:"",email:"",message:""}),n=t=>{o({...e,[t.target.name]:t.target.value})},s=t=>{t.preventDefault();const m=encodeURIComponent(`Website contact from ${e.name}`),r=encodeURIComponent(`Name: ${e.name}
Email: ${e.email}
